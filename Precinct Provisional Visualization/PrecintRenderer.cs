...
namespace Precinct_Provisional_Visualization
{
    public class PrecintRenderer
    {
        ...
        public void draw(string currentPrecinctstring)
        {
            ...
            fillRectangle(Color.Black, new Rectangle(1210, 850, 60, 60));
            drawCenteredString("20", new Rectangle(1210, 850, 60, 60), whiteBrush, titleFont);
            fillRectangle(Color.Black, new Rectangle(1210, 780, 60, 60));

            if (currentPrecinct.r20 == "DEM")
            {
                rRating = "D";
                drawCenteredString(rRating, new Rectangle(1210, 780, 60, 60), aquaBrush, titleFont);
            }
            else if (currentPrecinct.r20 == "REP")
            {
                rRating = "R";
                drawCenteredString(rRating, new Rectangle(1210, 780, 60, 60), redBrush, titleFont);
            }
            else
            {
                rRating = "";
